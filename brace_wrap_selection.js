...
if (extensions.bracematcher && extensions.bracematcher.onkeypress_handler) {
    // Remove the existing trigger handler, we'll re-instate it.
    var editor_pane = ko.views.manager.topView;
    editor_pane.removeEventListener('keypress', extensions.bracematcher.onkeypress_handler, true);
}
extensions.bracematcher = {};

(function() {

    var log = ko.logging.getLogger("bracematcher");
